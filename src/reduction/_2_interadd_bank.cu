...
__global__ void
interadd_bankconflict_kernel(float* g_odata, float* g_idata)
{
...
void parser::reduce_interbank( matrix& C) {
    ...
    interadd_bankconflict_kernel<<< 3 , 4 , 32 * sizeof(float)>>>(dev_c, dev_a);
