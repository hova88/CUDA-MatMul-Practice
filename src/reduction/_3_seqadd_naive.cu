...
__global__ void
sequential_address_naive_kernel(float* g_odata, float* g_idata)
{
...
void parser::reduce_seqnaive( matrix& C) {
    ...
    sequential_address_naive_kernel<<< 3 , 4 , 32 * sizeof(float)>>>(dev_c, dev_a);
